...
tiles = 49
datasize = 1000
biosample = "bc_organoid_weighted_belnding_"



#FUNCTION RETURN PATCH AS AB IMAGE
# def get_patch(l,uby,ubx,patchsize,cr,ch_list,ch_percentile,p):
def get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,alphas):
...
def main_DataGenerator(filepath,per,patchsize,channels,l_layer,u_layer,tiles,biosample,datasize):
    ...
    for t in range(t_train):    
        ...
        image_AB = get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,alphas)
