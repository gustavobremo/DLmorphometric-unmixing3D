...
tiles = 49
datasize = 1000
biosample = "bc_organoid_synthetic_"



#FUNCTION RETURN PATCH AS AB IMAGE
# def get_patch(l,uby,ubx,patchsize,cr,ch_list,ch_percentile,p):
def get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,alpha1,alpha2):
...
def main_DataGenerator(filepath,per,patchsize,channels,l_layer,u_layer,tiles,biosample,datasize):
    ...
    alpha1 = 0.5
    alpha2 = 0.5
    datafoldername = biosample+str(alpha1)+"_"+str(alpha2)+"_"+"patches_data_"+str(int((datasize/1000)))+"k"
    ...
    for t in range(t_train):    
        ...
        image_AB = get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,alpha1,alpha2)
