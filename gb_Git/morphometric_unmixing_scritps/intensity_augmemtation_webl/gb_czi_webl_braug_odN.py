...
brightnessRange = [1,4]
prob = 80
biosample = "bc_org_r_br_webl"+str(prob)+"_odN_"+str(per)
datatype = "synthetic"
...
def get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,brightnesslist,prob,datatype):
        ...
        membrane_channel = channel_normalized_patches_list[0]
        nuclear_channel = channel_normalized_patches_list[1]
        open_detector_channel = channel_normalized_patches_list[2]
