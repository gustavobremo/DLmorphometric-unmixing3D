...
prob = 50
biosample = "bc_org_r_odN_test_100"+str(per)
...
def get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,brightnesslist,prob):
        ...
        source_image[:,:,0] = channel_normalized_patches_list[2]
        source_image[:,:,1] = channel_normalized_patches_list[2]
        source_image[:,:,2] = channel_normalized_patches_list[2]
        #-------------------------------------------------------------
        ...
        return(image_AB,source_image,target_image)
        # return(0)
# --------------------------------------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------------------------------------
def main_DataGenerator(filepath,per,patchsize,channels,l_layer,u_layer,tiles,biosample,datasize,brightnessRange,prob):
    ...
    if os.path.exists(datafoldername+"/test_A")==False:
            os.mkdir(datafoldername+"/test_A")

    if os.path.exists(datafoldername+"/test_B")==False:
    ...
    for t in range(t_test):  
        image_AB = get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,brightnesslist,prob)
        matplotlib.image.imsave(datafoldername+"/test/"+str(t)+'.png', image_AB[0].astype(np.uint8))
        matplotlib.image.imsave(datafoldername+"/test_A/"+str(t)+'.png', image_AB[1].astype(np.uint8))
        matplotlib.image.imsave(datafoldername+"/test_B/"+str(t)+'.png', image_AB[2].astype(np.uint8))
...
main_DataGenerator(filepath,per,patchsize,channels,l_layer,u_layer,tiles,biosample,datasize,brightnessRange,prob)
