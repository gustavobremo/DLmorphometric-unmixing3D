...
prob = 50
biosample = "bc_org_real_braug_0.5_3_"+str(prob)+"_pctmN"
...
def get_patch(l,uby,ubx,patchsize,channels,channel_stacks,percentiles,t,brightnesslist,prob):
        ...
        for c in range(channels):
            ...
            if c == 2:
                ...
                normalized_patch = (patch/percentiles[0])*255         
        ...
        #-------------------------------------------------------------
        #Enhanding brightness of source image randomly and constrained by a probability value
